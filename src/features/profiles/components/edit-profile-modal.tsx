            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div className="border rounded-lg p-4 space-y-4 bg-muted/30">
                <div className="space-y-0.5">
                  <label className="text-sm font-medium">Login Credentials & System Role</label>
                  <p className="text-xs text-muted-foreground">
                    Update password to grant/change login access. Choose role to control permissions.
                  </p>
                </div>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <p className="text-xs text-muted-foreground">
                          Set password to grant login access
                        </p>
                        <FormMessage />
                      </FormItem>
                    )}
