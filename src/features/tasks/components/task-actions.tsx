...
export const TaskActions = ({ id, projectId, assigneeId, children }: TaskActionsProps) => {
  ...
  // Determine if this is an individual task (no project) or project task
  const isIndividualTask = !projectId;
  ...
  const canDelete = permissions.role === MemberRole.ADMIN; // Only ADMIN can delete
