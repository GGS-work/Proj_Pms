...
// Export the raw client for direct SQL queries (bypasses Drizzle serialization issues)
export const sql_client = client;

// Create the database instance
// Note: For operations that cause #state errors (UPDATE/DELETE without .returning()),
// use sql_client directly with raw SQL queries
